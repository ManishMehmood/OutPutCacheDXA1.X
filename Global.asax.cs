...
namespace Sdl.Web.Site
{
    public class MvcApplication : HttpApplication
    {
        ...
        {
			//This code checks of the URL is not in cache or User did not hit clear cache querystring in browser then inser the uri in cache with the current date time
            if (HttpRuntime.Cache.Get(HttpContext.Current.Request.Url.AbsoluteUri) == null && HttpContext.Current.Request["ClearCache"] != "true")
            {
                HttpRuntime.Cache.Insert(HttpContext.Current.Request.Url.AbsoluteUri, DateTime.Now);
            }
